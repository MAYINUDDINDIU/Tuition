        ...
        <div class="grid gap-0   xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 lg:px-10  mt-3 lg:mt-5">
            ...
            <Card
                ...
                href="#">
                   ...
                   <img
                    alt="Bonnie image"
                    className="mb-3 xs:w-14 h-12  lg:w-24 lg:h-24"
                    src={std_info}
                    />
              </div>
            ...
            <Card
                ...
                <h6 className="xs:text-xs xs:text-center lg:text-center mt-0 lg:text-2xl font-bold tracking-tight text-dark dark:text-white">
                    <p>
                    Class Schedule
                    </p>
                </h6>
